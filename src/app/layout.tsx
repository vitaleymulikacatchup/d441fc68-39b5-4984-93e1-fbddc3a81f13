...
export const metadata: Metadata = {
  title: "SaasFlow - Collaboration Tools for Modern Teams",
  description: "Streamline your workflow with SaasFlow. Real-time collaboration, smart automation, and team productivity tools built for speed.",
  keywords: "SaaS, collaboration, team management, productivity, workflow automation",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    ...
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763829556979-397pgov6.jpg",
        alt: "SaasFlow - Modern collaboration platform"
      }
    ]
  },
  twitter: {
    ...
    title: "SaasFlow - Collaboration Tools for Modern Teams",
    description: "Streamline your workflow with SaasFlow. Real-time collaboration, smart automation, and team productivity tools built for speed.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763829556979-397pgov6.jpg"]
  }
};
